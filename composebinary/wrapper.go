...
func (wrapper *ComposeWrapper) Deploy(projectName, host string, filePaths []string, envFilePath string) error {
...
func (wrapper *ComposeWrapper) Remove(projectName, host string, filePaths []string) error {
